...
use crate::alpha::builtin;
use crate::alpha::common;
use crate::alpha::common::*;
use crate::alpha::error::Error;
use crate::alpha::error::Errors;
use crate::alpha::error::OperandValueType;
use crate::alpha::error::Poisonable;
		...
		match self
		{
			...
			} =>
			{
				let unresolved = Expression::FunctionCall {
					...
					builtin,
					arguments,
					return_type: Some(Ok(ValueType::Void)),
				};
				let value = unresolved.resolve()?;
				Ok(resolved::Statement::EvaluateAndDiscard { value })
			}
